...
int main()
{
	...
	file.close();
	fstream file1;
	file1.open("mess4.txt",ios::in|ios::binary);
	int u;
	cout<<"enter uid"<<endl;
	cin>>u;
	int found = 0;
...
*/	
  /* fstream file4;
   ...
   file4.close();*/
                                  // modify content randomly                         
    fstream file5;
   file5.open("mess4.txt",ios::ate|ios::binary|ios::in|ios::out);
   cout<<"\nEnter the no. of object to be updated "<<endl;
   int k;
   cin>>k;
        cin.get(ch);
   int l = (k-1)*sizeof(m);
   ...
   *///file5.close();
     ...
     file5.seekg(0);//go to start

cout<<"contents of updated file"<<endl; 
 cout<<"\nvalue before reading from file"<<m.a<<endl;
